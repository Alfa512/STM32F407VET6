...
bool MPU9250_init(bool calib_gyro, bool MPU9250_calib_acc){
...
void MPU9250_calib_mag(){
    ...
    //response[0]=MPU9250_WriteReg(MPUREG_EXT_SENS_DATA_01|READ_FLAG, 0x00); //Read I2C 
...
void MPU9250_calibrate(float *dest1, float *dest2){  
    ...
    // get stable time source; Auto MPU9250_select clock source to be PLL gyroscope reference if ready 
